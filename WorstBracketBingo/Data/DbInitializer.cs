...
namespace WorstBracketBingo.Data
{
    public static class DbInitializer
    {
        public static void Initialize(BingoContext context)
        {
            ...
            {
                new BoardPiece{ BingoBoardID = 2, ContenderID = 14, BoardPosition = 0},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 16, BoardPosition = 1},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 32, BoardPosition = 2},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 10, BoardPosition = 3},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 11, BoardPosition = 4},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 29, BoardPosition = 5},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 28, BoardPosition = 6},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 9, BoardPosition = 7},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 12, BoardPosition = 8},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 6, BoardPosition = 9},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 30, BoardPosition = 10},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 13, BoardPosition = 11},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 4, BoardPosition = 12},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 25, BoardPosition = 13},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 15, BoardPosition = 14},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 5, BoardPosition = 15},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 8, BoardPosition = 16},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 1, BoardPosition = 17},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 26, BoardPosition = 18},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 17, BoardPosition = 19},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 27, BoardPosition = 20},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 59, BoardPosition = 21},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 7, BoardPosition = 22},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 23, BoardPosition = 23},
                new BoardPiece{ BingoBoardID = 2, ContenderID = 31, BoardPosition = 24},

                new BoardPiece{ BingoBoardID = 1, ContenderID = 21, BoardPosition = 0},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 16, BoardPosition = 1},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 45, BoardPosition = 2},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 41, BoardPosition = 3},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 36, BoardPosition = 4},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 43, BoardPosition = 5},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 34, BoardPosition = 6},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 42, BoardPosition = 7},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 12, BoardPosition = 8},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 22, BoardPosition = 9},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 19, BoardPosition = 10},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 38, BoardPosition = 11},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 1, BoardPosition = 12},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 18, BoardPosition = 13},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 15, BoardPosition = 14},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 2, BoardPosition = 15},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 35, BoardPosition = 16},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 39, BoardPosition = 17},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 44, BoardPosition = 18},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 20, BoardPosition = 19},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 37, BoardPosition = 20},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 40, BoardPosition = 21},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 50, BoardPosition = 22},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 3, BoardPosition = 23},
                new BoardPiece{ BingoBoardID = 1, ContenderID = 33, BoardPosition = 24},

                new BoardPiece{ BingoBoardID = 3, ContenderID = 68, BoardPosition = 0},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 47, BoardPosition = 1},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 54, BoardPosition = 2},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 24, BoardPosition = 3},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 61, BoardPosition = 4},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 58, BoardPosition = 5},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 66, BoardPosition = 6},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 55, BoardPosition = 7},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 60, BoardPosition = 8},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 46, BoardPosition = 9},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 30, BoardPosition = 10},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 57, BoardPosition = 11},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 50, BoardPosition = 12},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 64, BoardPosition = 13},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 67, BoardPosition = 14},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 49, BoardPosition = 15},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 51, BoardPosition = 16},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 39, BoardPosition = 17},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 63, BoardPosition = 18},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 62, BoardPosition = 19},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 52, BoardPosition = 20},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 65, BoardPosition = 21},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 56, BoardPosition = 22},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 48, BoardPosition = 23},
                new BoardPiece{ BingoBoardID = 3, ContenderID = 53, BoardPosition = 24}
            };
